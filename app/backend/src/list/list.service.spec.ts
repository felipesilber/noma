...
describe('ListService', () => {
  ...
  describe('getMyListById', () => {
    it('throws NotFound when list does not exist', async () => {
      ...
      await expect(service.getMyListById(10, 123)).rejects.toThrow(
        NotFoundException,
      );
    });
    ...
    it('throws Forbidden when not owner', async () => {
      ...
      await expect(service.getMyListById(10, 1)).rejects.toThrow(
        ForbiddenException,
      );
    });
  ...
  describe('updateList', () => {
    it('throws NotFound if list does not exist', async () => {
      ...
      await expect(service.updateList(10, 1, { name: 'x' })).rejects.toThrow(
        NotFoundException,
      );
    });
  ...
  describe('deleteList', () => {
    it('throws NotFound if list does not exist', async () => {
      ...
      await expect(service.deleteList(10, 1)).rejects.toThrow(
        NotFoundException,
      );
    });
  ...
  describe('addPlace', () => {
    it('throws NotFound if list does not exist', async () => {
      ...
      await expect(service.addPlace(10, 1, 55)).rejects.toThrow(
        NotFoundException,
      );
    });
    ...
    it('throws BadRequest if place does not exist', async () => {
      ...
      await expect(service.addPlace(10, 1, 999)).rejects.toThrow(
        BadRequestException,
      );
    });
  ...
  describe('removePlace', () => {
    it('throws NotFound if list does not exist', async () => {
      ...
      await expect(service.removePlace(10, 1, 55)).rejects.toThrow(
        NotFoundException,
      );
    });
  ...
  describe('reorder', () => {
    it('throws NotFound if list does not exist', async () => {
      ...
      await expect(
        service.reorder(10, 1, [{ placeId: 1, order: 1 }]),
