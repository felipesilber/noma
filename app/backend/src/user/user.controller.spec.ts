...
describe('UserController', () => {
    ...
    it('setMyUsername empty username', async () => {
        await expect(controller.setMyUsername(10, { username: '   ' })).rejects.toThrow('username is mandatory');
    ...
    it('setMyUsername P2002', async () => {
        ...
        await expect(controller.setMyUsername(10, { username: 'ed' })).rejects.toThrow('Already in use.');
    });
    it('findAll', async () => {
