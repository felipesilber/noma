    ...
    >
      ...
      <View style={styles.progressContainer}>
        ...
        <View style={styles.progressBarBackground}>
          <View
            style={[styles.progressBarFill, { width: `${(step + 1) * 25}%` }]}
          />
        </View>
      </View>
        ...
        {step === 0 && (
          <>
            ...
            {!isValidEmail && email.length > 0 ? (
              <AppText style={styles.error}>Informe um e-mail válido.</AppText>
            ) : null}
          </>
        )}
        ...
        {step === 3 && (
          <>
            ...
            {confirmSenha.length > 0 && !isConfirmOk ? (
              <AppText style={styles.error}>As senhas não coincidem.</AppText>
            ) : null}
          </>
        )}

        {erro ? (
          <AppText style={[styles.error, { marginTop: 8 }]}>{erro}</AppText>
        ) : null}
      </ScrollView>
